...
def draw_training_pos_and_cylinders():
    ...
    for (x, y), color in cylinders_coordinates:
        cylinder_patch = Circle(xy=(x, y), radius=0.3, facecolor=color)
...
if __name__ == '__main__':
    draw_training_pos_and_cylinders()
